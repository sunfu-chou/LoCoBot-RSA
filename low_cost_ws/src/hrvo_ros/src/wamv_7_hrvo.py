...
class BoatHRVO(object):
    def __init__(self):
        ...
        self.pub_v4 = rospy.Publisher("/wamv4/cmd_vel", Twist, queue_size=1)
        self.sub_p3d4 = rospy.Subscriber(
            "/wamv4/localization_gps_imu/odometry", Odometry, self.cb_boat4_odom, queue_size=1)
        self.sub_goal4 = rospy.Subscriber("/wamv4/move_base_simple/goal", PoseStamped, self.cb_goal4, queue_size=1)

        self.pub_v5 = rospy.Publisher("/wamv5/cmd_vel", Twist, queue_size=1)
        self.sub_p3d5 = rospy.Subscriber(
            "/wamv5/localization_gps_imu/odometry", Odometry, self.cb_boat5_odom, queue_size=1)
        self.sub_goal3 = rospy.Subscriber("/wamv5/move_base_simple/goal", PoseStamped, self.cb_goal5, queue_size=1)

        self.pub_v6 = rospy.Publisher("/wamv6/cmd_vel", Twist, queue_size=1)
        self.sub_p3d6 = rospy.Subscriber(
            "/wamv6/localization_gps_imu/odometry", Odometry, self.cb_boat6_odom, queue_size=1)
    ...
    def cb_hrvo(self, event):
        ...
        self.pub_v5.publish(self.cmd_drive[5])
        self.pub_v6.publish(self.cmd_drive[6])
