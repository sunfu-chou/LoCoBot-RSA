...
class DuckiecallTesterNode(unittest.TestCase):
    ...
    def test_duckiecall_output(self):
        ...
        rospy.loginfo("Published %d quacks to the number_of_quacks topic", msg_num_of_quacks.data)
        ...
        rospy.loginfo("Received %s from the duckiecall topic", self.msg_duckiecall.data)
